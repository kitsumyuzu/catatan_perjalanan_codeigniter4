                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="card">
                                    ...
                                    <form action="/catatan/edit_catatan/" method="post" enctype="multipart/form-data">

                                        <input type="hidden" name="CatatanID" value="<?php echo $catatanData -> id_catatan ?>">
                                                ...
                                                <!-- Birthdate input -->
                                                    ...
                                                    <div class="form-group form-inline col-md-12">
                                                        ...
                                                        <div class="col-md-10 p-0">
                                                            ...
                                                            <input class="form-control input-full" type="date" name="date" id="date_input" value="<?php echo $catatanData -> date ?>" required>
                                                ...
                                                <!-- Birthpalce input -->
                                                    ...
                                                    <div class="form-group form-inline col-md-12">
                                                        ...
                                                        <div class="col-md-10 p-0">
                                                            ...
                                                            <input class="form-control input-full" type="time" name="time" id="time_input" value="<?php echo $catatanData -> time ?>" required>
                                                ...
                                                <!-- Address input -->
                                                    ...
                                                    <div class="form-group form-inline col-md-12">
                                                        ...
                                                        <div class="col-md-10 p-0">
                                                            ...
                                                            <input class="form-control input-full" type="text" name="location" id="location_input" value="<?php echo $catatanData -> location ?>" placeholder="Location" maxlength="225" required>
                                                ...
                                                <!-- Job input -->
                                                    ...
                                                    <div class="form-group form-inline col-md-12">
                                                        ...
                                                        <div class="col-md-10 p-0">
                                                            ...
                                                            <input class="form-control input-full" type="text" name="temp" id="temp_input" value="<?php echo $catatanData -> temp ?>" placeholder="30.0⁰" required>
                                                ...
                                                <!-- Description input -->
                                                    ...
                                                    <div class="form-group form-inline col-md-12">
                                                        ...
                                                        <div class="col-md-10 p-0">
                                                            ...
                                                            <input class="form-control input-full" type="text" name="vehicle" id="vehicle_input" value="<?php echo $catatanData -> vehicle ?>" placeholder="Vehicle" maxlength="225" required>
                                                            ...
                                                            <div class="col-md-10 p-0">
                                                                ...
                                                                <select class="form-control input-full" name="pengguna" id="pengguna_input" required>
                                                                    ...
                                                                    <?php foreach ($penggunaData as $data) { ?>
                                                                        ...
                                                                        <option value="<?php echo $data -> _user ?>" <?php echo ($catatanData -> nickname == $data -> _user) ? 'selected' : '' ?>><?php echo ucwords($data -> first_name . " " . $data -> last_name) ?></option>
